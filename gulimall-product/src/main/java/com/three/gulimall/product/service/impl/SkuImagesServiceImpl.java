...
import com.three.gulimall.product.dao.SkuImagesDao;
import com.three.gulimall.product.entity.SkuImagesEntity;
import com.three.gulimall.product.service.SkuImagesService;
...
public class SkuImagesServiceImpl extends ServiceImpl<SkuImagesDao, SkuImagesEntity> implements SkuImagesService {
    ...
    public List<SkuImagesEntity> getImagesBySkuId(Long skuId) {
        List<SkuImagesEntity> skuImagesEntities = this.baseMapper.selectList(
