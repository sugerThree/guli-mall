...
import com.three.gulimall.search.feign.ProductFeignService;
import com.three.gulimall.search.service.MallSearchService;
import com.three.gulimall.search.vo.AttrResponseVo;
...
public class MallSearchServiceImpl implements MallSearchService {
    ...
    private SearchRequest buildSearchRequest(SearchParam param) {
        ...
        SearchRequest searchRequest = new SearchRequest(
                new String[]{EsConstant.PRODUCT_INDEX}, searchSourceBuilder);
        ...
        /*if (param.getBrandId() != null && param.getBrandId().size() > 0) {
            ...
            if (r.getCode() == 0) {
                ...
                for (SearchResult.BrandVo brandVo : brand) {
                    ...
                    replace = param.get_queryString().replace("&brandId=" + brandVo.getBrandId(), "");
                }
